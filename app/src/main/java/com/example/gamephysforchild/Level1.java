...
public class Level1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        dialog.setContentView(R.layout.dialoglight1);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                try
                {
                    Intent intent = new Intent(Level1.this, GameLevelsLight.class);// вернуться
        ...
        button_back.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                try
                {
                    Intent intent = new Intent(Level1.this, GameLevelsLight.class);
                    startActivity(intent);
                    finish();
                }
                catch (Exception e) {}
        ...
        Place[] places;
        places = new Place[2];
        places[0] = new Place(80, 160, false, 90);
        places[1] = new Place(80, 110, true, 0);

        LevelRay lr = new LevelRay(30, 160, 30, 60, 1, 2, places, 45);
