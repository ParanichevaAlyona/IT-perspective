...
public class Card2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialoglevel2);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                try
                {
                    Intent intent = new Intent(Card2.this, GameLevelsChoice.class);// вернуться
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            {
                try {
                    Intent intent = new Intent(Card2.this, Card3.class);
                    startActivity(intent);
                    finish();
                }
                catch (Exception e){}
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Card2.this, GameLevelsChoice.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e) {
                }
        ...
        final Animation a = AnimationUtils.loadAnimation(Card2.this, R.anim.alpha);
