...
public class Card3 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialoglevel3);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                try
                {
                    Intent intent = new Intent(Card3.this, GameLevelsChoice.class);// вернуться
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            {
                try {
                    Intent intent = new Intent(Card3.this, Block_levels.class);
                    startActivity(intent);
                    finish();
                }
                catch (Exception e){}
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Card3.this, GameLevelsChoice.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e) {
                }
        ...
        final Animation a = AnimationUtils.loadAnimation(Card3.this, R.anim.alpha);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener()
        {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent)
            {
                ...
                else if (motionEvent.getAction() == MotionEvent.ACTION_UP)
                {
                    ...
                    if (count == 5){ count = 0; dialogEnd.show();}
                    else
                    {
                        viborLR = random.nextInt(2);
                        if (viborLR == 0)
